...
const ArtistProfile = ({ setIsLoggedIn }) => {
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6]">
      {/* ✅ Container like navbar */}
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row gap-8">
          {/* Sidebar */}
          <div className="w-full md:w-64 bg-white p-4 shadow-md rounded-2xl h-fit sticky top-28">
            <nav>
              <ul className="space-y-3">
                ...
                <li onClick={() => setActiveTab("saleshistory")} className={`hover:bg-gray-100 p-2 rounded cursor-pointer flex items-center gap-2 ${activeTab === "saleshistory" ? "bg-gray-200 font-semibold" : ""}`}>
